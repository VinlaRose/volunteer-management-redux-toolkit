...
export const fetchEvents = createAsyncThunk(
  ...
  async () => {
    try {
      const response = await fetch('https://backend-testing-khaki.vercel.app/events');
...
export const deleteEvent = createAsyncThunk(
  ...
  async (eventId, { dispatch }) => {
    try {
      ...
      const response = await fetch(`https://backend-testing-khaki.vercel.app/events/${eventId}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
        },
